...
if(isset($_POST['patsub1'])){
  ...
  if($password==$cpassword){
  	$query="insert into patreg(fname,lname,gender,email,contact,password,cpassword,blood,address) values ('$fname','$lname','$gender','$email','$contact','$password','$cpassword','$blood','$address');";
