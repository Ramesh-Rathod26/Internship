    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
        <div class="container">
            ...
            <a class="navbar-brand js-scroll-trigger" href="#"
                ...
                <h4><i class="fa fa-user-plus" aria-hidden="true"></i>&nbsp BEL HOSPITALS</h4>
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item" style="margin-right: 20px;">
                    <li class="nav-item">
                        <a class="nav-link js-scroll-trigger" href="ambulance.html"
                            style="color: white;font-family: 'IBM Plex Sans', sans-serif;">
                            <h6>AMBULANCE</h6>
                        </a>
                    </li>
                        ...
                        <form method="post" action="func2.php">
                            <div class="row register-form">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <input type="text" minlength="10" maxlength="10" name="contact"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control" placeholder="Address *"
                                                name="address" onkeydown="return alphaOnly(event);" required />
                                        </div>
