...
<head>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top">
    ...
    <a class="navbar-brand" href="#"><i class="fa fa-user-plus" aria-hidden="true"></i> G13 Hospital </a>
    ...
    <div class="row">
      <div class="col-md-4" style="max-width:25%;margin-top: 3%;">
        <div class="list-group" id="list-tab" role="tablist">
          ...
          <a class="list-group-item list-group-item-action" href="#list-nl" id="list-nl-list" role="tab"
            data-toggle="list" aria-controls="home">Nurse List</a>
          ...
          <a class="list-group-item list-group-item-action" href="#list-nur" id="list-nur-list" role="tab"
            data-toggle="list" aria-controls="home">Add Nurse</a>
          <a class="list-group-item list-group-item-action" href="#list-dnur" id="list-dnur-list" role="tab"
            data-toggle="list" aria-controls="home">Delete Nurse</a>

          <a class="list-group-item list-group-item-action" href="#list-ins" id="list-ins-list" role="tab"
            data-toggle="list" aria-controls="home">Insurance</a>
          ...
          <a class="list-group-item list-group-item-action" href="#list-amb" id="list-amb-list" role="tab"
            data-toggle="list" aria-controls="home">Ambulance</a>
        </div><br>
      </div>
        ...
        <div class="tab-content" id="nav-tabContent" style="width: 950px;">
          ...
          <div class="tab-pane fade" id="list-doc" role="tabpanel" aria-labelledby="list-home-list">
            <div class="col-md-8">
              <form class="form-group" action="doctorsearch.php" method="post">
                <div class="row">
                  <div class="col-md-10"><input type="text" name="doctor_contact" placeholder="Enter Doctor ID"
          ...
          <div class="tab-pane fade" id="list-pat" role="tabpanel" aria-labelledby="list-pat-list">
            ...
            <div class="col-md-8">
              <form class="form-group" action="patientsearch.php" method="post">
                <div class="row">
                  <div class="col-md-10"><input type="text" name="patient_contact" placeholder="Enter Patient ID"
                      class="form-control"></div>
          ...
          <div class="tab-pane fade" id="list-dnur" role="tabpanel" aria-labelledby="list-dnur-list">
            <form class="form-group" method="post" action="admin-panel1.php">
              ...
              <input type="submit" name="nursub1" value="Delete Nurse" class="btn btn-primary"
                onclick="confirm('do you really want to delete?')">
            </form>
          </div>
          <!-- Insurance -->
              ...
              <div class="row">
                ...
                <div class="col-md-8">
                  <select name="ins_type" class="form-control" id="special" required="required">
                    ...
                    <option value="Floating" name="">Floater</option>
                ...
                <div class="col-md-8">
                  <select name="company" class="form-control" id="special" required="required">
                    <option value="head" name="" disabled selected>Select Type</option>
                    <option value="Apollo Munich Health Insurance Company Limited " name="">Apollo Munich Health
                      Insurance Company Limited </option>
                    <option value="Star Health & Allied Insurance Company Limited" name="">Star Health & Allied
                      Insurance Company Limited </option>
                    <option value="Max Bupa Health Insurance Company Limited " name="">Max Bupa Health Insurance Company
                      Limited </option>
                    <option value="ICICI Lombard General Insurance Company Limited" name="">ICICI Lombard General
                      Insurance Company Limited </option>
